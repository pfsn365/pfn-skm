...
<div class="all-screens-container">
  ...
  {/if}
  <div class="steps-container no-scrollbar">
    <div class="title-section">
      <div class="title-text">STEPS TO PLAY</div>
    </div>
    <div class="steps-section">
      <div class="step first">
        <div class="step-circle"><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="3"
            fill="none">
            <polyline points="20 6 9 17 4 12"></polyline>
          </svg></div>
        <div class="step-text">
          <div class="step-subtitle">Select <br />Team</div>
        </div>
      ...
      <div class="step second">
        ...
        <div class="step-text">
          <div class="step-subtitle">Cut Players / Restructure <br /> Contracts</div>
        </div>
        <div class="underline"></div>
      </div>
      <div class="step-connector">
      ...
      <div class="step third">
        ...
        <div class="step-text">
          <div class="step-subtitle">Re-sign & Tag <br /> Players</div>
        </div>
        <div class="underline"></div>
      </div>
      <div class="step-connector">
      ...
      <div class="step fourth">
        <div class="step-circle current">04</div>
        <div class="step-text">
          <div class="step-subtitle">Simulate Free <br /> Agency</div>
        </div>
        <div class="underline"></div>
      </div>
      <div class="step-connector">
      ...
      <div class="step fifth">
        <div class="step-circle pending">05</div>
        <div class="step-text">
          <div class="step-subtitle">Share <br /> Results</div>
        </div>
        <div class="underline"></div>
      </div>
    </div>
  ...
  <div id="screen1" class="screen active">
    ...
    <div class="footer">
      ...
      <button class="continue-btn disabled" disabled
        onclick="typeof selectTeam === 'function' && selectTeam()">CONTINUE</button>
    </div>
  </div>
  ...
  <div id="screen5" class="screen">
    ...
    <div class="footer-buttons">
      <button class="pfn-button" onclick="navigateToMDS()">GO TO PFN MDS</button>
...
{if $is_desktop}
  <div class="ad-container-sticky-right"></div>
{/if}
