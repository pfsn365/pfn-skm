...
<div class="players-container">
  <div class="players-positions">
    <button class="positions all selected" onclick="filterMDSPlayers('all')">All</button>
    <button class="positions offense" onclick="filterMDSPlayers('offense')">Offense</button>
    <button class="positions defense" onclick="filterMDSPlayers('defense')">Defense</button>
    <button class="positions st" onclick="filterMDSPlayers('st')">S/T</button>
  </div>
