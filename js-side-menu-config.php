...
define('TENNIS_SIMULATOR_SCRIPT_LOCATION', BUNDLE_STATIC_URL . '/js/production/pfn-proxy/tennis-simulator-bundle-390adb6bed.js');
define('NASCAR_PREDICTOR_SCRIPT_LOCATION', BUNDLE_STATIC_URL . '/js/production/pfn-proxy/nascar-predictor-bundle-85ef722335.js');
